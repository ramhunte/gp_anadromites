...
land_use_subs <- st_intersection(land_use_stilly, subs_stl) %>% 
  ...
  mutate(parcel_area_ha = st_area(.)/10000)
...
# color themes 
custom_colors <- c("Agricultural Area" = "#5e4fa2",
                   "Forest Lands" = "#66c2a5", 
                   "Mineral Resource Area" = "#fee08b",
                   "Other" = "#e6f598",
                   "Public" = "#d53e4f",
                   "ROW" = "#9e0142",
                   "Rural Character Residential" = "#abdda4",
                   "Intensive Urban" = "#f46d43",
                   "Water" = "#3288bd"
                   )
...
# st_write(floodplain_hab_stl, here("data", "fp_shapefiles", "floodplain_shapefiles.shp"), append = FALSE)
```
