...
```{r}
# Create a function to calculate cost estimates with inflation adjustment while retaining the geometry column
calculate_pond_cost_inflation_geometry <- function(input_df) {
...
pond_cost_stl_inflated_geometry <- calculate_pond_cost_inflation_geometry(hist_flood_stl_var_mult)
