...
elj_cost<-elj_no_inf_cost %>% 
  mutate(lower_cost_estimate=lower_cost_estimate*1.6728,
           upper_cost_estimate=upper_cost_estimate*1.6728) 
```
...
elj_cost$final_lower_cost<-elj_cost$lower_cost_estimate*elj_cost$length_mi
elj_cost$final_upper_cost<-elj_cost$upper_cost_estimate*elj_cost$length_mi
...
ggplot() +
  ...
  scale_color_viridis_c(breaks = c(0, 3000, 6000, 9000), option = "E", name = "Average Cost ($)", direction=-1)+
  theme_minimal()
```
