...
st_write(elj_cost_subbasin , here("data", "final_dfs", "elj_costs.gpkg"))
```
# MAP #1: Average Cost of RP Planting by Subbasin 
```{r}
#total cost
# hist(elj_cost_subbasin$avg_subba_cost)
ggplot() +
  geom_sf(data = elj_cost_subbasin, aes(fill = avg_subba_cost)) +
