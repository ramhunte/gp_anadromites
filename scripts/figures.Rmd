...
mutate(subbasin_name = str_replace_all(fp_area_subbasin$noaa_subba, "_", " "),
       subbasin_name = str_replace_all(fp_area_subbasin$subbasin_name, "Stillaguamish", ""),
       subbasin_name = str_replace_all(fp_area_subbasin$subbasin_name, "mainstem", "Mainstem"), 
       hab_unit = str_replace_all(fp_area_subbasin$hab_unit, "side_channel", "Side Channel"))

# plotting 
ggplot(fp_area_subbasin, aes(x = subbasin_name, 
                             y = total_area_ha, 
                             fill = hab_unit)) +
